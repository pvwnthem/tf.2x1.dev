          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center">
                ...
                <span className="font-medium text-green-600 text-lg">2x1.dev</span>
              </Link>
            </div>
            <div className="hidden lg:flex space-x-4 lg:items-center lg:justify-end lg:flex-1">
              ...
              <button  onClick={() => {scroll('contact')}} className=" px-3 py-2 bg-green-600 hover:bg-green-700 rounded-md text-white">
                Contact
              </button>
            </div>
